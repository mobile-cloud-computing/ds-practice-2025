...
class OrderExecutorServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendToken = channel.unary_unary(
                '/OrderExecutorService/SendToken',
...
def add_OrderExecutorServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'OrderExecutorService', rpc_method_handlers)
...
class OrderExecutorService(object):
    ...
    def SendToken(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/OrderExecutorService/SendToken',
