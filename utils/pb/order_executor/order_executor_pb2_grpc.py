...
class OrderExecutorControlStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Election = channel.unary_unary(
                '/order_executor.OrderExecutorControl/Election',
        ...
        self.Coordinator = channel.unary_unary(
                '/order_executor.OrderExecutorControl/Coordinator',
                request_serializer=order__executor__pb2.CoordinatorRequest.SerializeToString,
                response_deserializer=order__executor__pb2.Ack.FromString,
                _registered_method=True)
        self.Heartbeat = channel.unary_unary(
                '/order_executor.OrderExecutorControl/Heartbeat',
                request_serializer=order__executor__pb2.HeartbeatRequest.SerializeToString,
                response_deserializer=order__executor__pb2.Ack.FromString,
                _registered_method=True)


class OrderExecutorControlServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_OrderExecutorControlServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Coordinator': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=order__executor__pb2.Ack.SerializeToString,
            ),
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'order_executor.OrderExecutorControl', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('order_executor.OrderExecutorControl', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class OrderExecutorControl(object):
    """Missing associated documentation comment in .proto file."""
    ...
    def Coordinator(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            order__executor__pb2.Ack.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
