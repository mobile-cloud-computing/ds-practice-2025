...
class FraudDetectionServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UpdateClock = channel.unary_unary(
                '/fraud_detection.FraudDetectionService/UpdateClock',
                request_serializer=fraud__detection__pb2.ClockUpdateRequest.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                _registered_method=True)
...
def add_FraudDetectionServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UpdateClock': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=fraud__detection__pb2.ClockUpdateRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
...
class FraudDetectionService(object):
    ...
    def UpdateClock(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/fraud_detection.FraudDetectionService/UpdateClock',
            fraud__detection__pb2.ClockUpdateRequest.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
