...
class TransactionVerificationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UpdateClock = channel.unary_unary(
                '/transaction_verification.TransactionVerificationService/UpdateClock',
                request_serializer=transaction__verification__pb2.ClockUpdateRequest.SerializeToString,
                response_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
                _registered_method=True)
...
def add_TransactionVerificationServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UpdateClock': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=transaction__verification__pb2.ClockUpdateRequest.FromString,
                    response_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
            ),
...
class TransactionVerificationService(object):
    ...
    def UpdateClock(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/transaction_verification.TransactionVerificationService/UpdateClock',
            transaction__verification__pb2.ClockUpdateRequest.SerializeToString,
            google_dot_protobuf_dot_empty__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
